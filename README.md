...
Projects are GitHub repositories discovered via **OPA-Hub** (identity / orgs), **OAM** (connector/credential storage and model bindings), and **ORA** (GitHub App / PAT protocol). Job workspaces are ephemeral tmp clones.
...
export PEER_OAM_URL=http://127.0.0.1:8090
export PEER_ORA_URL=http://127.0.0.1:8091
export OPEN_SERVICE_JWT_SECRET=…   # shared with hub/ora/oam
go run .
