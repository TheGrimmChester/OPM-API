...
// ApproveForCoding moves a task from human_review → queue (AutoCursor approve-for-coding).
...
// TaskValidActions mirrors AutoCursor getTaskValidActions for the web board.
